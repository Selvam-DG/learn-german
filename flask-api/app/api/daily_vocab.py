...
daily_vocab_bp = Blueprint("daily_vocab", __name__, url_prefix="/vocab")
...
def to_dict(v):
    return {
        ...
        "plural": v.plural,
        "phrases": v.phrases,
        "synonyms": getattr(v, "synonyms", None) or [],
        "notes": getattr(v, "notes", None) or "",
